...
# render real
render_real_root = os.path.join(cur_dir, '../data/LINEMOD_6D/LM6d_render_v1/data/render_real')
real_set_root = os.path.join(cur_dir, '../data/LINEMOD_6D/LM6d_render_v1/image_set/real')
# ==========================================================
...
def gen_render_real():
    for cls_idx, cls_name in idx2class.items():
        ...
        for real_idx in tqdm(all_indices):
            ...
            # read pose -------------------------------------
            real_meta_path = os.path.join(real_data_root, "{}-meta.mat".format(real_idx))
