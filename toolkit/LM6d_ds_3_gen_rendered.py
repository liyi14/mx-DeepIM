                ...
                for inner_idx in range(rendered_per_real):
                    if gen_images:
                        image_file = os.path.join(rendered_dir,
                                                  '{}_{}_{}-color.png'.format(class_name, real_prefix, inner_idx))
                        depth_file = os.path.join(rendered_dir,
                                                  '{}_{}_{}-depth.png'.format(class_name, real_prefix, inner_idx))
                        ...
                        pose_file = os.path.join(rendered_dir,
                                        '{}_{}_{}-pose.txt'.format(class_name, real_prefix, inner_idx))
