...
print("angle_std={}, angle_max={}, x_std={}, y_std={}, z_std={}".format(
...
for cls_idx, cls_name in idx2class.items():
    ...
    sel_set_file = os.path.join(observed_set_root, "{}_{}.txt".format(
        cls_name, image_set))
    ...
    for observed_idx in tqdm(image_list):
        ...
        pose_path = os.path.join(gt_observed_root, cls_name,
