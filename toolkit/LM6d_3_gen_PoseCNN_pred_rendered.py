    ...
    for small_class_idx, class_name in enumerate(class_name_list):
        ...
        for idx, observed_index in enumerate(tqdm(observed_index_list)):
            ...
            if labels != -1:
                ...
                pose_ori_file = os.path.join(rendered_dir, '{}_{}_{}-pose.txt'.format(class_name, observed_prefix_list[idx], 0))
                pose_icp_file = os.path.join(rendered_dir, '{}_{}_{}-pose_icp.txt'.format(class_name, observed_prefix_list[idx], 0))
                image_file = os.path.join(rendered_dir, '{}_{}_{}-color.png'.format(class_name, observed_prefix_list[idx], 0))
                depth_file = os.path.join(rendered_dir, '{}_{}_{}-depth.png'.format(class_name, observed_prefix_list[idx], 0))
                segmentation_file = os.path.join(rendered_dir, '{}_{}_{}-label.png'.format(class_name, observed_prefix_list[idx], 0))
