...
# output path
pose_dir = os.path.join(LM6d_occ_root, 'rendered_poses')
    ...
    for image_set in image_set_list:
        ...
        for observed_idx in tqdm(image_list):
            ...
            if image_set == 'train':
                ...
                pose_path = os.path.join(gt_observed_root, 'val', cls_name, "{}-pose.txt".format(prefix))
        ...
        output_file_name = os.path.join(pose_dir, 'LM6d_occ_{}_rendered_pose_{}.txt'.format(image_set, cls_name))
