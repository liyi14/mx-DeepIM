...
def load_gt_pairdb(cfg, dataset_name, image_set_name, root_path, dataset_path, class_name, result_path=None,
                   pair_flip=False, img_flip=False):
    print(image_set_name, root_path, dataset_path, result_path)
    imdb = eval(dataset_name)(cfg, image_set_name, root_path, dataset_path, class_name=class_name, result_path=result_path)
