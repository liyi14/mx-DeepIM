...
if __name__ == "__main__":
    ...
    idx2 = "001378"
    im_src = cv2.imread(
        "/home/yili/PoseEst/render_pangolin/synthesize/train/002_master_chef_can/{}_color.png".format(idx1),
        cv2.IMREAD_COLOR,
    )
    im_tgt = cv2.imread(
        "/home/yili/PoseEst/render_pangolin/synthesize/train/002_master_chef_can/{}_color.png".format(idx2),
        cv2.IMREAD_COLOR,
    )
    depth_src = (
        cv2.imread(
            "/home/yili/PoseEst/render_pangolin/synthesize/train/002_master_chef_can/{}_depth.png".format(idx1),
    ...
    depth_tgt = (
        cv2.imread(
            "/home/yili/PoseEst/render_pangolin/synthesize/train/002_master_chef_can/{}_depth.png".format(idx2),
            cv2.IMREAD_UNCHANGED,
        ).astype(np.float32)
        / 10000
    )
    pose_src = np.loadtxt(
        "/home/yili/PoseEst/render_pangolin/synthesize/train/002_master_chef_can/{}_pose.txt".format(idx1), skiprows=1
    )
    if True:
    ...
    pose_tgt = np.loadtxt(
        "/home/yili/PoseEst/render_pangolin/synthesize/train/002_master_chef_can/{}_pose.txt".format(idx2), skiprows=1
    )
