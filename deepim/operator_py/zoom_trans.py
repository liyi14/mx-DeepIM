...
class ZoomTransOperator(mx.operator.CustomOp):
    ...
    def forward(self, is_train, req, in_data, out_data, aux):
        ...
        self.assign(out_data[0], req[0],
                    mx.ndarray.array(zoom_trans_delta_array, ctx=ctx))
    ...
    def backward(self, req, out_grad, in_data, out_data, in_grad, aux):
        ...
        for batch_idx in range(batch_size):
            ...
            wy = zoom_factor_array[batch_idx][0]
            assert wx == wy
            zoom_grad_x, zoom_grad_y, zoom_grad_z = zoom_trans_grad_array[
                batch_idx]
            if self.b_zoom_grad:
                if self.b_inv_zoom:
        ...
        self.assign(in_grad[1], req[1],
                    mx.ndarray.array(trans_grad_array, ctx=ctx))
...
if __name__ == '__main__':
    ...
    exe1 = proj2d.simple_bind(
        ...
        trans_delta=v_trans_delta.shape)
    ...
    exe2.arg_dict['trans_delta'][:] = mx.ndarray.array(
        zoom_trans_delta_mx, ctx=ctx)
